...
class Common {
    ...
    public static function createDefaultConfig($config_path) {
        if ($file=fopen($config_path,'a+'))
    ...
    /**
     * <b style="color: red;">Рекурсивное удаление папки</b>
     * 
     * @param path $dir Путь к папке
